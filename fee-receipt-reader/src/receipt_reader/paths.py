...
La variable de entorno `RECEIPT_READER_DATA_DIR` permite forzar otra ruta.
"""
...
from receipt_reader import APP_NAME

DATA_DIR_ENV = "RECEIPT_READER_DATA_DIR"
DB_FILENAME = "receipt_reader.db"
...
class AppPaths:
    ...
    def samples_dir(self) -> Path:
        """Archivos de muestra para procesar con OCR real desde la interfaz."""
        return self.data_dir / "muestras"

    @property
    def demo_lot_dir(self) -> Path:
        """Archivos del lote sintético con que se puebla la base de ejemplo."""
        return self.data_dir / "lote_demo"
