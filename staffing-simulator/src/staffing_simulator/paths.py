...
La variable de entorno `STAFFING_SIMULATOR_DATA_DIR` permite forzar otra ruta.
"""
...
from staffing_simulator import APP_NAME

DATA_DIR_ENV = "STAFFING_SIMULATOR_DATA_DIR"
DB_FILENAME = "staffing_simulator.db"
